...
bTSPInstances=bash cat Solution_Progress.list | parallel -P 4 -k --eta >> ${outputFile}
#bTSPInstances=bash cat Batch_Files_varying_K.list | parallel -P 4 -k --eta >> ${outputFile}
